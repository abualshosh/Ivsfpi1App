...
describe('Complain Management Component', () => {
  let comp: ComplainComponent;
  let fixture: ComponentFixture<ComplainComponent>;
  let service: ComplainService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'complain', component: ComplainComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ComplainComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.complains?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
